...
public class AuthServiceTest {
    ...
    public void setUpUser() {
        user = new User("testUser", "name", "", "", new ArrayList<>(), 0L, Gender.MALE, "", "password", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    }
    ...
    public void testRegister_NewUser() {
        User user = new User("newUser", "name", "", "", new ArrayList<>(), 0L, Gender.MALE, "", "password", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    ...
    public void testDeleteUser_Success() {
        User user = new User("testUser", "name", "", "", new ArrayList<>(), 0L, Gender.MALE, "", "password", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        Post post = new Post(1L, user, "Post message", 1234567, new ArrayList<>(), new ArrayList<>(), new HashSet<>());
        user.addPost(post);
        User user2 = new User("testUser2", "name2", "", "", new ArrayList<>(), 0L, Gender.MALE, "", "password", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    ...
    public void testDeleteUser_AdminCanDeleteOtherUser() {
        ...
        User adminUser = new User("adminUser", "Admin Name", "", "", new ArrayList<>(), 0L, Gender.MALE, "", "password", "", new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
