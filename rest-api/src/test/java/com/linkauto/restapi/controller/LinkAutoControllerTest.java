...
public class LinkAutoControllerTest {
    ...
    public void testReportUser() {
        ...
        when(authService.isTokenValid(userToken)).thenReturn(true);
        User reportingUser = new User("reportingUser", "name", "pic", "email", new ArrayList<>(), 123L, Gender.MALE, "loc", "pass", "desc", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        ...
        User reportedUser = new User(username, "name", "pic", "email", new ArrayList<>(), 123L, Gender.MALE, "loc", "pass", "desc", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    ...
    public void testDeleteReport() {
        ...
        User reportedUser = new User("reportingUser", "name", "pic", "email", new ArrayList<>(), 123L, Gender.MALE, "loc", "pass", "desc", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    ...
    public void testParseUserToUserReturnerDTO_WithReporters() {
        // Arrange
        User reporter1 = new User("reporter1", "Reporter One", "pic1", "email1", new ArrayList<>(), 111L, Gender.FEMALE, "loc1", "pass1", "desc1", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        User reporter2 = new User("reporter2", "Reporter Two", "pic2", "email2", new ArrayList<>(), 222L, Gender.MALE, "loc2", "pass2", "desc2", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        User mainUser = new User("mainUser", "Main User", "mainPic", "mainEmail", new ArrayList<>(), 333L, Gender.OTHER, "mainLoc", "mainPass", "mainDesc", new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
